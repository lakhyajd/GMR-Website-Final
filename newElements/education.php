...
<div class="picture" style="background-image: url('<?php perch_content("backgroundImage1"); ?>')">
    ...
    <div class="textApply grid gridContainer">
        ...
        <div class="textApplyFlex">
            <a href="<?php perch_content('../../../gmrcms/resources/admin/apprentice-ensemble-programmeapplication-information-2019-1.docx'); ?>" class="btn btn-sm animation whiteButton gridUp"><?php perch_content('button1Text'); ?></a>
            <a href="<?php perch_content('../../../gmrcms/resources/admin/apprentice-ensemble-programme-application-form-2019-3.docx'); ?>" class="btn btn-sm animation whiteButton gridDown"><?php perch_content('button2Text'); ?></a>
        </div>
    </div>
</div>
